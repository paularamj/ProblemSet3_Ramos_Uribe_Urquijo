...
##Caja de coordenadas que contiene el poligono de Chapinero - Bogot谩
...
housing_chapinero <- st_join(x=BASE_chapinero , y=Bogota_mzn) #Validaci贸n se mantienen las 15165 obs
housing_poblado <- st_join(x=BASE_poblado , y=Medellin_mzn) #Validaci贸n se mantienen las 1677 obs
...
###########################################################################################
########## --------- Modelos de Predicci贸n de precios ----------- ##########################
############################################################################################
...
# Identificamos cu谩ntos cores tiene nuestra m谩quina
n_cores <- detectCores()
